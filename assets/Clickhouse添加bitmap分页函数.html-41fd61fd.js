...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),v={href:"https://github.com/ClickHouse/ClickHouse/pull/27234",target:"_blank",rel:"noopener noreferrer"},b=n("h2",{id:"后续",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#后续","aria-hidden":"true"},"#"),e(" 后续")],-1),g=n("p",null,[e("后面又来了个需求，要求标签能够修改，这又炸了，Clickhosue是不支持修改的，bitmap采用的数据结构是"),n("code",null,"AggregateFunction(groupBitmap, UInt32)"),e("，groupBitmap的合并逻辑是或运算，内部Clickhosue开发了一种新的数据结构"),n("code",null,"xor_groupBitmap"),e("，支持合并逻辑异或运算，变相支持删除操作，考虑这部分并不通用，所以没有开源出来")],-1);function h(k,_){const i=c("ExternalLinkIcon");return l(),d("div",null,[o,n("p",null,[e("在Clickhouse中bitmap指向的class是"),u,e("，bitmap底层使用的是RoaringBitmap，github地址："),n("a",p,[e("https://github.com/RoaringBitmap/CRoaring.git，`RoaringBitmapWithSmallSet`对rb进行了包装，在这个类下添加分页函数"),s(i)])]),m,n("p",null,[e("这样就完事了，最终这部分的代码提交到了Clickhosue仓库，最终得到了合并，"),n("a",v,[e("https://github.com/ClickHouse/ClickHouse/pull/27234"),s(i)])]),b,g])}const B=t(r,[["render",h],["__file","Clickhouse添加bitmap分页函数.html.vue"]]);export{B as default};
