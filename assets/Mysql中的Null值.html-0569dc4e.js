import{_ as e,X as l,Y as n,a1 as s}from"./framework-dc96d9cf.js";const a={},d=s(`<h1 id="mysql中的null值" tabindex="-1"><a class="header-anchor" href="#mysql中的null值" aria-hidden="true">#</a> Mysql中的Null值</h1><p>在大对数编程语言中，逻辑表达式的值只有两种：True，False。但是在关系型数据库中的逻辑表达式并非两种，而是三值逻辑的表达式(True、False、Unknown)。</p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>select null = 1;
