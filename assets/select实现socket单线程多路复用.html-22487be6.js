import{_ as n,W as i,X as e,Z as s}from"./framework-a8aed956.js";const l={},d=s(`<h1 id="linux-select实现socket单线程多路复用" tabindex="-1"><a class="header-anchor" href="#linux-select实现socket单线程多路复用" aria-hidden="true">#</a> Linux select实现socket单线程多路复用</h1><p>select版本比阻塞版本的性能起码高了3倍+</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># select版本</span>
