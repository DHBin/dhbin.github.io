...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),b={href:"https://github.com/ClickHouse/ClickHouse/pull/27234",target:"_blank",rel:"noopener noreferrer"},g=e("h2",{id:"后续",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#后续","aria-hidden":"true"},"#"),n(" 后续")],-1),h=e("p",null,[n("后面又来了个需求，要求标签能够修改，这又炸了，Clickhosue是不支持修改的，bitmap采用的数据结构是"),e("code",null,"AggregateFunction(groupBitmap, UInt32)"),n("，groupBitmap的合并逻辑是或运算，内部Clickhosue开发了一种新的数据结构"),e("code",null,"xor_groupBitmap"),n("，支持合并逻辑异或运算，变相支持删除操作，考虑这部分并不通用，所以没有开源出来")],-1);function k(_,f){const i=l("ExternalLinkIcon");return d(),c("div",null,[o,e("p",null,[n("在Clickhouse中bitmap指向的class是"),u,n("，bitmap底层使用的是RoaringBitmap，github地址："),e("a",p,[n("https://github.com/RoaringBitmap/CRoaring.git"),s(i)]),n(" ，"),m,n("对rb进行了包装，在这个类下添加分页函数")]),v,e("p",null,[n("这样就完事了，最终这部分的代码提交到了Clickhosue仓库，最终得到了合并，"),e("a",b,[n("https://github.com/ClickHouse/ClickHouse/pull/27234"),s(i)])]),g,h])}const x=t(r,[["render",k],["__file","Clickhouse添加bitmap分页函数.html.vue"]]);export{x as default};
