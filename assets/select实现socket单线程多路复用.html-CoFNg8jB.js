import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as e,c as i,e as s}from"./app-Bq0Sc4vP.js";const l={},a=s(`<h1 id="linux-select实现socket单线程多路复用" tabindex="-1"><a class="header-anchor" href="#linux-select实现socket单线程多路复用"><span>Linux select实现socket单线程多路复用</span></a></h1><p>select版本比阻塞版本的性能起码高了3倍+</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># select版本</span>
