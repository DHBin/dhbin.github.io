...
在`src`目录下新建一个文件`learn.h`，在这里面定义入口
...
修改`src/Makefile`，这一步参考[chore: 修改调用learn的方式 · DHBin/redis@1052b3e (github.com)](https://github.com/DHBin/redis/commit/1052b3e34bc94589d414fd2059728323f004573b)，不一一描述

修改`src/server.c`，这里面包含了一个mian函数，程序的入口，其中有一段是这样子的
