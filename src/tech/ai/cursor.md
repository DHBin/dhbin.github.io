...
> AIGC: 这篇文章详细介绍了“Cursor提示词”及其在AI协作中的应用规则，重点阐述了软件开发团队中AI与用户协作的RIPER-5五阶段工作流（研究、调查、计划、执行、审查），并明确了每个阶段的目标、核心工具、产出物和交互要求。文章还提出了双层记忆系统（文档记忆与内存记忆）和时间戳原则，确保信息的时效性和可追溯性。此外，文中规定了AI在协作过程中的五大角色（项目经理、产品经理、架构师、开发负责人、文档管理），要求AI在每个阶段结合不同角色的思考导向，保障项目高效、规范、可持续地推进。
